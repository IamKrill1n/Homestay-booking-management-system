...
INSERT INTO homestays (
  ...
  (01, 'Homestay Da Lat View', 'Phong view doi, gan trung tam', 150000, TRUE, 'approved', 11.9404, 108.4583, '123 Tran Phu', 'Da Lat'),
  (02, 'Coastal Homestay Nha Trang', 'Gan bien, co be boi', 200000, TRUE, 'approved', 12.2388, 109.1967, '45 Tran Phu', 'Nha Trang'),
  (03, 'Budget Room Da Lat', 'Gia re, phu hop sinh vien', 80000, FALSE, 'pending', 11.9465, 108.4419, '8 Nguyen Chi Thanh', 'Da Lat')
ON CONFLICT (homestay_id) DO NOTHING;
